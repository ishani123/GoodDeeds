					...
					<div class="col-sm-4 col-xs-12 header-links">
						...
						<!-- register Starts -->
                                                            ...
                                                            <ul class="nav navbar-nav">
                                                                <li>
									<a href="<?php echo site_url()?>/register_user/load_register_page">
										<i class="fa fa-lock hidden-lg hidden-md" title="Register"></i>
										<span class="hidden-sm hidden-xs">
											Register
										</span>
									</a>
						...
						<!-- login Starts -->
							<ul class="nav navbar-nav">
                                                                <li>
									<a href="<?php echo site_url()?>/login_user/load_login_page">
			...
			<div class="container">
				...
				<!-- Logo Starts -->
					<div class="span12 pagination-centered">
						<div id="logo" >
							<a href="<?php echo base_url();?>"><img src="<?php echo base_url();?>application_resources/images/logo.png" title="Spice Shoppe" alt="Spice Shoppe" class="img-responsive" /></a>
						</div>
					</div>
				<!-- Logo Starts -->				
			 ...
			 <!--Navbar Cat collapse Starts--> 
				<div class="collapse navbar-collapse navbar-cat-collapse">
					<ul class="nav navbar-nav">
						...
						<li class="dropdown">
							<a href="category-list.html" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="10">About us </a>
						...
						<li><a href="<?php echo site_url();?>/category/categories">Computers </a></li>
...
<!-- Footer Section Ends -->
<!-- JavaScript Files -->
<script src="<?php echo base_url();?>application_resources/js/jquery-1.11.1.min.js"></script>
<script src="<?php echo base_url();?>application_resources/js/jquery-migrate-1.2.1.min.js"></script>	
<!--<script src="<?php echo base_url();?>application_resources/js/bootstrap.min.js"></script>-->
<script src="<?php echo base_url();?>application_resources/js/bootstrap-hover-dropdown.min.js"></script>
<script src="<?php echo base_url();?>application_resources/js/jquery.magnific-popup.min.js"></script>
<script src="<?php echo base_url();?>application_resources/js/owl.carousel.min.js"></script>
<!--<script src="<?php echo base_url();?>application_resources/js/custom.js"></script>-->
